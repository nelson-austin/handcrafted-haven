  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <fieldset className="border p-4">
        ...
        <ul>
          <li>
            <label className="block">All Items: {totalItems}</label>
            <p className="cartTotal" id="cartTotal"></p>
          </li>
          <li>
            <label className="orderTotal block">
              <b>Order Total: ${totalCost.toFixed(2)}</b>
            </label>
            <p id="orderTotal"></p>
          </li>
        </ul>
      ...
      <div className="flex justify-center">
        <button
          ...
          className="bg-green-800 m-3 ml-0 mr-0 text-2xl rounded-lg p-2 flex justify-center items-center md:hover:bg-green-700 text-sky-100 w-[200px] lg:w-[270px]"
        >
          Click to pay 
        </button>
      </div>
