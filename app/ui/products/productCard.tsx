...
import { CardProps } from '../../dashboard/products/page';

export default function ProductCard({ cardImage, price, description }: CardProps) {
  return (
    <div className='flex flex-col items-center justify-center p-4 bg-blue-50'>
      <div className="max-w-sm rounded overflow-hidden shadow-lg mx-4 my-4">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-gray-700 text-base font-semibold">${price.toFixed(2)}</p>
        </div>
